...
class Keys {
  ...
  static const requestCameraPermissionButton =
      Key('requestCameraPermissionButton');
  static const requestMicrophonePermissionButton =
      Key('requestMicrophonePermissionButton');
  static const requestLocationPermissionButton =
      Key('requestLocationPermissionButton');
  static const requestGalleryPermissionButton =
      Key('requestGalleryPermissionButton');

  // location screen
  static const grantLocationPermissionButton =
      Key('grantLocationPermissionButton');
  ...
  static const showNotificationLaterButton2 =
      Key('showNotificationLaterButton2');
