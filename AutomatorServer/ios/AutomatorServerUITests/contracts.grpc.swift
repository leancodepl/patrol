...
internal protocol Patrol_NativeAutomatorClientProtocol: GRPCClient {
  ...
  func pressHome(
    _ request: Patrol_PressHomeRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Patrol_PressHomeRequest, Patrol_PressHomeResponse>

  func pressBack(
    _ request: Patrol_PressBackRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Patrol_PressBackRequest, Patrol_PressBackResponse>

  func pressRecentApps(
    _ request: Patrol_PressRecentAppsRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Patrol_PressRecentAppsRequest, Patrol_PressRecentAppsResponse>

  func doublePressRecentApps(
    _ request: Patrol_DoublePressRecentAppsRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Patrol_DoublePressRecentAppsRequest, Patrol_DoublePressRecentAppsResponse>

  func openApp(
    _ request: Patrol_OpenAppRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Patrol_OpenAppRequest, Patrol_OpenAppResponse>

  func openNotifications(
    _ request: Patrol_OpenNotificationsRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Patrol_OpenNotificationsRequest, Patrol_OpenNotificationsResponse>

  func openQuickSettings(
    _ request: Patrol_OpenQuickSettingsRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Patrol_OpenQuickSettingsRequest, Patrol_OpenQuickSettingsResponse>

  func enableDarkMode(
    _ request: Patrol_DarkModeRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Patrol_DarkModeRequest, Patrol_DarkModeResponse>
  ...
  func enableWiFi(
    ...
    callOptions: CallOptions?
  ) -> UnaryCall<Patrol_WiFiRequest, Patrol_WiFiResponse>
  ...
  func enableCellular(
    ...
    callOptions: CallOptions?
  ) -> UnaryCall<Patrol_CellularRequest, Patrol_CellularResponse>
  ...
  func tap(
    ...
    callOptions: CallOptions?
  ) -> UnaryCall<Patrol_TapRequest, Patrol_TapResponse>
  ...
  func enterText(
    ...
    callOptions: CallOptions?
  ) -> UnaryCall<Patrol_EnterTextRequest, Patrol_EnterTextResponse>

  func swipe(
    _ request: Patrol_SwipeRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Patrol_SwipeRequest, Patrol_SwipeResponse>

  func handlePermissionDialog(
    _ request: Patrol_HandlePermissionRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Patrol_HandlePermissionRequest, Patrol_HandlePermissionResponse>

  func setLocationAccuracy(
    _ request: Patrol_SetLocationAccuracyRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Patrol_SetLocationAccuracyRequest, Patrol_SetLocationAccuracyResponse>

  func tapOnNotification(
    _ request: Patrol_TapOnNotificationRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Patrol_TapOnNotificationRequest, Patrol_TapOnNotificationResponse>
}
...
internal protocol Patrol_NativeAutomatorAsyncClientProtocol: GRPCClient {
  ...
  func makePressHomeCall(
    _ request: Patrol_PressHomeRequest,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Patrol_PressHomeRequest, Patrol_PressHomeResponse>

  func makePressBackCall(
    _ request: Patrol_PressBackRequest,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Patrol_PressBackRequest, Patrol_PressBackResponse>

  func makePressRecentAppsCall(
    _ request: Patrol_PressRecentAppsRequest,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Patrol_PressRecentAppsRequest, Patrol_PressRecentAppsResponse>

  func makeDoublePressRecentAppsCall(
    _ request: Patrol_DoublePressRecentAppsRequest,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Patrol_DoublePressRecentAppsRequest, Patrol_DoublePressRecentAppsResponse>

  func makeOpenAppCall(
    _ request: Patrol_OpenAppRequest,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Patrol_OpenAppRequest, Patrol_OpenAppResponse>

  func makeOpenNotificationsCall(
    _ request: Patrol_OpenNotificationsRequest,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Patrol_OpenNotificationsRequest, Patrol_OpenNotificationsResponse>

  func makeOpenQuickSettingsCall(
    _ request: Patrol_OpenQuickSettingsRequest,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Patrol_OpenQuickSettingsRequest, Patrol_OpenQuickSettingsResponse>

  func makeEnableDarkModeCall(
    _ request: Patrol_DarkModeRequest,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Patrol_DarkModeRequest, Patrol_DarkModeResponse>
  ...
  func makeEnableWiFiCall(
    _ request: Patrol_WiFiRequest,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Patrol_WiFiRequest, Patrol_WiFiResponse>
  ...
  func makeEnableCellularCall(
    _ request: Patrol_CellularRequest,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Patrol_CellularRequest, Patrol_CellularResponse>
  ...
  func makeTapCall(
    _ request: Patrol_TapRequest,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Patrol_TapRequest, Patrol_TapResponse>
  ...
  func makeEnterTextCall(
    _ request: Patrol_EnterTextRequest,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Patrol_EnterTextRequest, Patrol_EnterTextResponse>

  func makeSwipeCall(
    _ request: Patrol_SwipeRequest,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Patrol_SwipeRequest, Patrol_SwipeResponse>

  func makeHandlePermissionDialogCall(
    _ request: Patrol_HandlePermissionRequest,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Patrol_HandlePermissionRequest, Patrol_HandlePermissionResponse>

  func makeSetLocationAccuracyCall(
    _ request: Patrol_SetLocationAccuracyRequest,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Patrol_SetLocationAccuracyRequest, Patrol_SetLocationAccuracyResponse>

  func makeTapOnNotificationCall(
    _ request: Patrol_TapOnNotificationRequest,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Patrol_TapOnNotificationRequest, Patrol_TapOnNotificationResponse>
}
...
extension Patrol_NativeAutomatorAsyncClientProtocol {
  internal func pressHome(
    _ request: Patrol_PressHomeRequest,
    callOptions: CallOptions? = nil
  ) async throws -> Patrol_PressHomeResponse {
  ...
  internal func pressBack(
    _ request: Patrol_PressBackRequest,
    callOptions: CallOptions? = nil
  ) async throws -> Patrol_PressBackResponse {
    return try await self.performAsyncUnaryCall(
      path: Patrol_NativeAutomatorClientMetadata.Methods.pressBack.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
  ...
  internal func pressRecentApps(
    _ request: Patrol_PressRecentAppsRequest,
    callOptions: CallOptions? = nil
  ) async throws -> Patrol_PressRecentAppsResponse {
    return try await self.performAsyncUnaryCall(
      path: Patrol_NativeAutomatorClientMetadata.Methods.pressRecentApps.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
  ...
  internal func doublePressRecentApps(
    _ request: Patrol_DoublePressRecentAppsRequest,
    callOptions: CallOptions? = nil
  ) async throws -> Patrol_DoublePressRecentAppsResponse {
    return try await self.performAsyncUnaryCall(
      path: Patrol_NativeAutomatorClientMetadata.Methods.doublePressRecentApps.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
  ...
  internal func openApp(
    _ request: Patrol_OpenAppRequest,
    callOptions: CallOptions? = nil
  ) async throws -> Patrol_OpenAppResponse {
    return try await self.performAsyncUnaryCall(
      path: Patrol_NativeAutomatorClientMetadata.Methods.openApp.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
  ...
  internal func openNotifications(
    _ request: Patrol_OpenNotificationsRequest,
    callOptions: CallOptions? = nil
  ) async throws -> Patrol_OpenNotificationsResponse {
    return try await self.performAsyncUnaryCall(
      path: Patrol_NativeAutomatorClientMetadata.Methods.openNotifications.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
  ...
  internal func openQuickSettings(
    _ request: Patrol_OpenQuickSettingsRequest,
    callOptions: CallOptions? = nil
  ) async throws -> Patrol_OpenQuickSettingsResponse {
    return try await self.performAsyncUnaryCall(
      path: Patrol_NativeAutomatorClientMetadata.Methods.openQuickSettings.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
  ...
  internal func enableDarkMode(
    _ request: Patrol_DarkModeRequest,
    callOptions: CallOptions? = nil
  ) async throws -> Patrol_DarkModeResponse {
    return try await self.performAsyncUnaryCall(
      path: Patrol_NativeAutomatorClientMetadata.Methods.enableDarkMode.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
  ...
  internal func enableWiFi(
    _ request: Patrol_WiFiRequest,
    callOptions: CallOptions? = nil
  ) async throws -> Patrol_WiFiResponse {
    return try await self.performAsyncUnaryCall(
      path: Patrol_NativeAutomatorClientMetadata.Methods.enableWiFi.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
  ...
  internal func enableCellular(
    _ request: Patrol_CellularRequest,
    callOptions: CallOptions? = nil
  ) async throws -> Patrol_CellularResponse {
    return try await self.performAsyncUnaryCall(
      path: Patrol_NativeAutomatorClientMetadata.Methods.enableCellular.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
  ...
  internal func tap(
    _ request: Patrol_TapRequest,
    callOptions: CallOptions? = nil
  ) async throws -> Patrol_TapResponse {
    return try await self.performAsyncUnaryCall(
      path: Patrol_NativeAutomatorClientMetadata.Methods.tap.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
  ...
  internal func enterText(
    _ request: Patrol_EnterTextRequest,
    callOptions: CallOptions? = nil
  ) async throws -> Patrol_EnterTextResponse {
    return try await self.performAsyncUnaryCall(
      path: Patrol_NativeAutomatorClientMetadata.Methods.enterText.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
  ...
  internal func swipe(
    _ request: Patrol_SwipeRequest,
    callOptions: CallOptions? = nil
  ) async throws -> Patrol_SwipeResponse {
    return try await self.performAsyncUnaryCall(
      path: Patrol_NativeAutomatorClientMetadata.Methods.swipe.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
  ...
  internal func handlePermissionDialog(
    _ request: Patrol_HandlePermissionRequest,
    callOptions: CallOptions? = nil
  ) async throws -> Patrol_HandlePermissionResponse {
    return try await self.performAsyncUnaryCall(
      path: Patrol_NativeAutomatorClientMetadata.Methods.handlePermissionDialog.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
  ...
  internal func setLocationAccuracy(
    _ request: Patrol_SetLocationAccuracyRequest,
    callOptions: CallOptions? = nil
  ) async throws -> Patrol_SetLocationAccuracyResponse {
    return try await self.performAsyncUnaryCall(
      path: Patrol_NativeAutomatorClientMetadata.Methods.setLocationAccuracy.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
  ...
  internal func tapOnNotification(
    _ request: Patrol_TapOnNotificationRequest,
    callOptions: CallOptions? = nil
  ) async throws -> Patrol_TapOnNotificationResponse {
    return try await self.performAsyncUnaryCall(
      path: Patrol_NativeAutomatorClientMetadata.Methods.tapOnNotification.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
...
internal protocol Patrol_NativeAutomatorClientInterceptorFactoryProtocol: GRPCSendable {
  ...
  func makepressHomeInterceptors() -> [ClientInterceptor<Patrol_PressHomeRequest, Patrol_PressHomeResponse>]

  /// - Returns: Interceptors to use when invoking 'pressBack'.
  func makepressBackInterceptors() -> [ClientInterceptor<Patrol_PressBackRequest, Patrol_PressBackResponse>]

  /// - Returns: Interceptors to use when invoking 'pressRecentApps'.
  func makepressRecentAppsInterceptors() -> [ClientInterceptor<Patrol_PressRecentAppsRequest, Patrol_PressRecentAppsResponse>]

  /// - Returns: Interceptors to use when invoking 'doublePressRecentApps'.
  func makedoublePressRecentAppsInterceptors() -> [ClientInterceptor<Patrol_DoublePressRecentAppsRequest, Patrol_DoublePressRecentAppsResponse>]

  /// - Returns: Interceptors to use when invoking 'openApp'.
  func makeopenAppInterceptors() -> [ClientInterceptor<Patrol_OpenAppRequest, Patrol_OpenAppResponse>]
  ...
  func makedisableDarkModeInterceptors() -> [ClientInterceptor<Patrol_DarkModeRequest, Patrol_DarkModeResponse>]

  /// - Returns: Interceptors to use when invoking 'enableWiFi'.
  func makeenableWiFiInterceptors() -> [ClientInterceptor<Patrol_WiFiRequest, Patrol_WiFiResponse>]

  /// - Returns: Interceptors to use when invoking 'disableWiFi'.
  func makedisableWiFiInterceptors() -> [ClientInterceptor<Patrol_WiFiRequest, Patrol_WiFiResponse>]

  /// - Returns: Interceptors to use when invoking 'enableCellular'.
  func makeenableCellularInterceptors() -> [ClientInterceptor<Patrol_CellularRequest, Patrol_CellularResponse>]

  /// - Returns: Interceptors to use when invoking 'disableCellular'.
  func makedisableCellularInterceptors() -> [ClientInterceptor<Patrol_CellularRequest, Patrol_CellularResponse>]
  ...
  func maketapInterceptors() -> [ClientInterceptor<Patrol_TapRequest, Patrol_TapResponse>]

  /// - Returns: Interceptors to use when invoking 'doubleTap'.
  func makedoubleTapInterceptors() -> [ClientInterceptor<Patrol_TapRequest, Patrol_TapResponse>]

  /// - Returns: Interceptors to use when invoking 'enterText'.
  func makeenterTextInterceptors() -> [ClientInterceptor<Patrol_EnterTextRequest, Patrol_EnterTextResponse>]

  /// - Returns: Interceptors to use when invoking 'swipe'.
  func makeswipeInterceptors() -> [ClientInterceptor<Patrol_SwipeRequest, Patrol_SwipeResponse>]

  /// - Returns: Interceptors to use when invoking 'handlePermissionDialog'.
  func makehandlePermissionDialogInterceptors() -> [ClientInterceptor<Patrol_HandlePermissionRequest, Patrol_HandlePermissionResponse>]

  /// - Returns: Interceptors to use when invoking 'setLocationAccuracy'.
  func makesetLocationAccuracyInterceptors() -> [ClientInterceptor<Patrol_SetLocationAccuracyRequest, Patrol_SetLocationAccuracyResponse>]

  /// - Returns: Interceptors to use when invoking 'tapOnNotification'.
  func maketapOnNotificationInterceptors() -> [ClientInterceptor<Patrol_TapOnNotificationRequest, Patrol_TapOnNotificationResponse>]
}
...
internal protocol Patrol_NativeAutomatorProvider: CallHandlerProvider {
  ...
  func pressHome(request: Patrol_PressHomeRequest, context: StatusOnlyCallContext) -> EventLoopFuture<Patrol_PressHomeResponse>

  func pressBack(request: Patrol_PressBackRequest, context: StatusOnlyCallContext) -> EventLoopFuture<Patrol_PressBackResponse>

  func pressRecentApps(request: Patrol_PressRecentAppsRequest, context: StatusOnlyCallContext) -> EventLoopFuture<Patrol_PressRecentAppsResponse>

  func doublePressRecentApps(request: Patrol_DoublePressRecentAppsRequest, context: StatusOnlyCallContext) -> EventLoopFuture<Patrol_DoublePressRecentAppsResponse>

  func openApp(request: Patrol_OpenAppRequest, context: StatusOnlyCallContext) -> EventLoopFuture<Patrol_OpenAppResponse>

  func openNotifications(request: Patrol_OpenNotificationsRequest, context: StatusOnlyCallContext) -> EventLoopFuture<Patrol_OpenNotificationsResponse>

  func openQuickSettings(request: Patrol_OpenQuickSettingsRequest, context: StatusOnlyCallContext) -> EventLoopFuture<Patrol_OpenQuickSettingsResponse>

  func enableDarkMode(request: Patrol_DarkModeRequest, context: StatusOnlyCallContext) -> EventLoopFuture<Patrol_DarkModeResponse>

  func disableDarkMode(request: Patrol_DarkModeRequest, context: StatusOnlyCallContext) -> EventLoopFuture<Patrol_DarkModeResponse>

  func enableWiFi(request: Patrol_WiFiRequest, context: StatusOnlyCallContext) -> EventLoopFuture<Patrol_WiFiResponse>

  func disableWiFi(request: Patrol_WiFiRequest, context: StatusOnlyCallContext) -> EventLoopFuture<Patrol_WiFiResponse>

  func enableCellular(request: Patrol_CellularRequest, context: StatusOnlyCallContext) -> EventLoopFuture<Patrol_CellularResponse>

  func disableCellular(request: Patrol_CellularRequest, context: StatusOnlyCallContext) -> EventLoopFuture<Patrol_CellularResponse>
  ...
  func tap(request: Patrol_TapRequest, context: StatusOnlyCallContext) -> EventLoopFuture<Patrol_TapResponse>

  func doubleTap(request: Patrol_TapRequest, context: StatusOnlyCallContext) -> EventLoopFuture<Patrol_TapResponse>

  func enterText(request: Patrol_EnterTextRequest, context: StatusOnlyCallContext) -> EventLoopFuture<Patrol_EnterTextResponse>

  func swipe(request: Patrol_SwipeRequest, context: StatusOnlyCallContext) -> EventLoopFuture<Patrol_SwipeResponse>

  func handlePermissionDialog(request: Patrol_HandlePermissionRequest, context: StatusOnlyCallContext) -> EventLoopFuture<Patrol_HandlePermissionResponse>

  func setLocationAccuracy(request: Patrol_SetLocationAccuracyRequest, context: StatusOnlyCallContext) -> EventLoopFuture<Patrol_SetLocationAccuracyResponse>

  func tapOnNotification(request: Patrol_TapOnNotificationRequest, context: StatusOnlyCallContext) -> EventLoopFuture<Patrol_TapOnNotificationResponse>
}
  ...
  internal func handle(
    ...
    case "pressHome":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Patrol_PressHomeRequest>(),
        responseSerializer: ProtobufSerializer<Patrol_PressHomeResponse>(),
        interceptors: self.interceptors?.makepressHomeInterceptors() ?? [],
    ...
    case "pressBack":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Patrol_PressBackRequest>(),
        responseSerializer: ProtobufSerializer<Patrol_PressBackResponse>(),
        interceptors: self.interceptors?.makepressBackInterceptors() ?? [],
    ...
    case "pressRecentApps":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Patrol_PressRecentAppsRequest>(),
        responseSerializer: ProtobufSerializer<Patrol_PressRecentAppsResponse>(),
        interceptors: self.interceptors?.makepressRecentAppsInterceptors() ?? [],
    ...
    case "doublePressRecentApps":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Patrol_DoublePressRecentAppsRequest>(),
        responseSerializer: ProtobufSerializer<Patrol_DoublePressRecentAppsResponse>(),
        interceptors: self.interceptors?.makedoublePressRecentAppsInterceptors() ?? [],
    ...
    case "openApp":
      return UnaryServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_OpenAppResponse>(),
        interceptors: self.interceptors?.makeopenAppInterceptors() ?? [],
    ...
    case "openNotifications":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Patrol_OpenNotificationsRequest>(),
        responseSerializer: ProtobufSerializer<Patrol_OpenNotificationsResponse>(),
        interceptors: self.interceptors?.makeopenNotificationsInterceptors() ?? [],
    ...
    case "enableDarkMode":
      return UnaryServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_DarkModeResponse>(),
        interceptors: self.interceptors?.makeenableDarkModeInterceptors() ?? [],
    ...
    case "enableWiFi":
      return UnaryServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_WiFiResponse>(),
        interceptors: self.interceptors?.makeenableWiFiInterceptors() ?? [],
    ...
    case "enableCellular":
      return UnaryServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_CellularResponse>(),
        interceptors: self.interceptors?.makeenableCellularInterceptors() ?? [],
    ...
    case "tap":
      return UnaryServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_TapResponse>(),
        interceptors: self.interceptors?.maketapInterceptors() ?? [],
    ...
    case "enterText":
      return UnaryServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_EnterTextResponse>(),
        interceptors: self.interceptors?.makeenterTextInterceptors() ?? [],
    ...
    case "swipe":
      return UnaryServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_SwipeResponse>(),
        interceptors: self.interceptors?.makeswipeInterceptors() ?? [],
    ...
    case "handlePermissionDialog":
      return UnaryServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_HandlePermissionResponse>(),
        interceptors: self.interceptors?.makehandlePermissionDialogInterceptors() ?? [],
    ...
    case "setLocationAccuracy":
      return UnaryServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_SetLocationAccuracyResponse>(),
        interceptors: self.interceptors?.makesetLocationAccuracyInterceptors() ?? [],
    ...
    case "tapOnNotification":
      return UnaryServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_TapOnNotificationResponse>(),
        interceptors: self.interceptors?.maketapOnNotificationInterceptors() ?? [],
...
internal protocol Patrol_NativeAutomatorAsyncProvider: CallHandlerProvider {
  ...
  @Sendable func pressHome(
    request: Patrol_PressHomeRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> Patrol_PressHomeResponse

  @Sendable func pressBack(
    request: Patrol_PressBackRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> Patrol_PressBackResponse

  @Sendable func pressRecentApps(
    request: Patrol_PressRecentAppsRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> Patrol_PressRecentAppsResponse

  @Sendable func doublePressRecentApps(
    request: Patrol_DoublePressRecentAppsRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> Patrol_DoublePressRecentAppsResponse
  ...
  @Sendable func openNotifications(
    request: Patrol_OpenNotificationsRequest,
    context: GRPCAsyncServerCallContext
  ) async throws -> Patrol_OpenNotificationsResponse
...
internal protocol Patrol_NativeAutomatorServerInterceptorFactoryProtocol {
  ...
  func makepressHomeInterceptors() -> [ServerInterceptor<Patrol_PressHomeRequest, Patrol_PressHomeResponse>]

  /// - Returns: Interceptors to use when handling 'pressBack'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makepressBackInterceptors() -> [ServerInterceptor<Patrol_PressBackRequest, Patrol_PressBackResponse>]

  /// - Returns: Interceptors to use when handling 'pressRecentApps'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makepressRecentAppsInterceptors() -> [ServerInterceptor<Patrol_PressRecentAppsRequest, Patrol_PressRecentAppsResponse>]

  /// - Returns: Interceptors to use when handling 'doublePressRecentApps'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makedoublePressRecentAppsInterceptors() -> [ServerInterceptor<Patrol_DoublePressRecentAppsRequest, Patrol_DoublePressRecentAppsResponse>]

  /// - Returns: Interceptors to use when handling 'openApp'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeopenAppInterceptors() -> [ServerInterceptor<Patrol_OpenAppRequest, Patrol_OpenAppResponse>]

  /// - Returns: Interceptors to use when handling 'openNotifications'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeopenNotificationsInterceptors() -> [ServerInterceptor<Patrol_OpenNotificationsRequest, Patrol_OpenNotificationsResponse>]
  ...
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeenableDarkModeInterceptors() -> [ServerInterceptor<Patrol_DarkModeRequest, Patrol_DarkModeResponse>]

  /// - Returns: Interceptors to use when handling 'disableDarkMode'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makedisableDarkModeInterceptors() -> [ServerInterceptor<Patrol_DarkModeRequest, Patrol_DarkModeResponse>]

  /// - Returns: Interceptors to use when handling 'enableWiFi'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeenableWiFiInterceptors() -> [ServerInterceptor<Patrol_WiFiRequest, Patrol_WiFiResponse>]

  /// - Returns: Interceptors to use when handling 'disableWiFi'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makedisableWiFiInterceptors() -> [ServerInterceptor<Patrol_WiFiRequest, Patrol_WiFiResponse>]

  /// - Returns: Interceptors to use when handling 'enableCellular'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeenableCellularInterceptors() -> [ServerInterceptor<Patrol_CellularRequest, Patrol_CellularResponse>]

  /// - Returns: Interceptors to use when handling 'disableCellular'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makedisableCellularInterceptors() -> [ServerInterceptor<Patrol_CellularRequest, Patrol_CellularResponse>]
  ...
  ///   Defaults to calling `self.makeInterceptors()`.
  func maketapInterceptors() -> [ServerInterceptor<Patrol_TapRequest, Patrol_TapResponse>]

  /// - Returns: Interceptors to use when handling 'doubleTap'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makedoubleTapInterceptors() -> [ServerInterceptor<Patrol_TapRequest, Patrol_TapResponse>]

  /// - Returns: Interceptors to use when handling 'enterText'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeenterTextInterceptors() -> [ServerInterceptor<Patrol_EnterTextRequest, Patrol_EnterTextResponse>]

  /// - Returns: Interceptors to use when handling 'swipe'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeswipeInterceptors() -> [ServerInterceptor<Patrol_SwipeRequest, Patrol_SwipeResponse>]

  /// - Returns: Interceptors to use when handling 'handlePermissionDialog'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makehandlePermissionDialogInterceptors() -> [ServerInterceptor<Patrol_HandlePermissionRequest, Patrol_HandlePermissionResponse>]

  /// - Returns: Interceptors to use when handling 'setLocationAccuracy'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makesetLocationAccuracyInterceptors() -> [ServerInterceptor<Patrol_SetLocationAccuracyRequest, Patrol_SetLocationAccuracyResponse>]

  /// - Returns: Interceptors to use when handling 'tapOnNotification'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func maketapOnNotificationInterceptors() -> [ServerInterceptor<Patrol_TapOnNotificationRequest, Patrol_TapOnNotificationResponse>]
}
