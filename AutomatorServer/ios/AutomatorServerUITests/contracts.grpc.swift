...
internal protocol Patrol_NativeAutomatorClientProtocol: GRPCClient {
  ...
  func takeScreenshot(
    _ request: Patrol_TakeScreenshotRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Patrol_TakeScreenshotRequest, Patrol_Empty>
...
extension Patrol_NativeAutomatorClientProtocol {
  ...
  /// Unary call to takeScreenshot
  ///
  /// - Parameters:
  ///   - request: Request to send to takeScreenshot.
  ///   - callOptions: Call options.
  /// - Returns: A `UnaryCall` with futures for the metadata, status and response.
  internal func takeScreenshot(
    _ request: Patrol_TakeScreenshotRequest,
    callOptions: CallOptions? = nil
  ) -> UnaryCall<Patrol_TakeScreenshotRequest, Patrol_Empty> {
    return self.makeUnaryCall(
      path: Patrol_NativeAutomatorClientMetadata.Methods.takeScreenshot.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
      interceptors: self.interceptors?.maketakeScreenshotInterceptors() ?? []
    )
  }
...
internal protocol Patrol_NativeAutomatorAsyncClientProtocol: GRPCClient {
  ...
  func makeTakeScreenshotCall(
    _ request: Patrol_TakeScreenshotRequest,
    callOptions: CallOptions?
  ) -> GRPCAsyncUnaryCall<Patrol_TakeScreenshotRequest, Patrol_Empty>
...
extension Patrol_NativeAutomatorAsyncClientProtocol {
  ...
  internal func makeTakeScreenshotCall(
    _ request: Patrol_TakeScreenshotRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Patrol_TakeScreenshotRequest, Patrol_Empty> {
    return self.makeAsyncUnaryCall(
...
internal protocol Patrol_NativeAutomatorClientInterceptorFactoryProtocol: GRPCSendable {
  ...
  /// - Returns: Interceptors to use when invoking 'takeScreenshot'.
  func maketakeScreenshotInterceptors() -> [ClientInterceptor<Patrol_TakeScreenshotRequest, Patrol_Empty>]
...
internal enum Patrol_NativeAutomatorClientMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    ...
    methods: [
      ...
      Patrol_NativeAutomatorClientMetadata.Methods.takeScreenshot,
  ...
  internal enum Methods {
    ...
    internal static let takeScreenshot = GRPCMethodDescriptor(
      name: "takeScreenshot",
      path: "/patrol.NativeAutomator/takeScreenshot",
      type: GRPCCallType.unary
    )
...
internal protocol Patrol_NativeAutomatorProvider: CallHandlerProvider {
  ...
  func takeScreenshot(request: Patrol_TakeScreenshotRequest, context: StatusOnlyCallContext) -> EventLoopFuture<Patrol_Empty>
...
extension Patrol_NativeAutomatorProvider {
  ...
  internal func handle(
    ...
    case "takeScreenshot":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Patrol_TakeScreenshotRequest>(),
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.maketakeScreenshotInterceptors() ?? [],
        userFunction: self.takeScreenshot(request:context:)
      )
  ...
  internal func handle(
    ...
    case "takeScreenshot":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.maketakeScreenshotInterceptors() ?? [],
        wrapping: self.takeScreenshot(request:context:)
      )
...
internal protocol Patrol_NativeAutomatorServerInterceptorFactoryProtocol {
  ...
  /// - Returns: Interceptors to use when handling 'takeScreenshot'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func maketakeScreenshotInterceptors() -> [ServerInterceptor<Patrol_TakeScreenshotRequest, Patrol_Empty>]
...
internal enum Patrol_NativeAutomatorServerMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    ...
    methods: [
      ...
      Patrol_NativeAutomatorServerMetadata.Methods.takeScreenshot,
