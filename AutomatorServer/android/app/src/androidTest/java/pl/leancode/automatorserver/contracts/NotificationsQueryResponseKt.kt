...
@kotlin.jvm.JvmName("-initializenotificationsQueryResponse")
inline fun notificationsQueryResponse(block: pl.leancode.automatorserver.contracts.NotificationsQueryResponseKt.Dsl.() -> kotlin.Unit): pl.leancode.automatorserver.contracts.Contracts.NotificationsQueryResponse =
  pl.leancode.automatorserver.contracts.NotificationsQueryResponseKt.Dsl._create(pl.leancode.automatorserver.contracts.Contracts.NotificationsQueryResponse.newBuilder()).apply { block() }._build()
object NotificationsQueryResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    private val _builder: pl.leancode.automatorserver.contracts.Contracts.NotificationsQueryResponse.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: pl.leancode.automatorserver.contracts.Contracts.NotificationsQueryResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): pl.leancode.automatorserver.contracts.Contracts.NotificationsQueryResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun pl.leancode.automatorserver.contracts.Contracts.NotificationsQueryResponse.copy(block: pl.leancode.automatorserver.contracts.NotificationsQueryResponseKt.Dsl.() -> kotlin.Unit): pl.leancode.automatorserver.contracts.Contracts.NotificationsQueryResponse =
  pl.leancode.automatorserver.contracts.NotificationsQueryResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()
