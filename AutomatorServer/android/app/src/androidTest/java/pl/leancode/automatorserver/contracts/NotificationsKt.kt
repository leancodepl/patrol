...
@kotlin.jvm.JvmName("-initializenotifications")
inline fun notifications(block: pl.leancode.automatorserver.contracts.NotificationsKt.Dsl.() -> kotlin.Unit): pl.leancode.automatorserver.contracts.Contracts.Notifications =
  pl.leancode.automatorserver.contracts.NotificationsKt.Dsl._create(pl.leancode.automatorserver.contracts.Contracts.Notifications.newBuilder()).apply { block() }._build()
object NotificationsKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  class Dsl private constructor(
    private val _builder: pl.leancode.automatorserver.contracts.Contracts.Notifications.Builder
  ) {
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: pl.leancode.automatorserver.contracts.Contracts.Notifications.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): pl.leancode.automatorserver.contracts.Contracts.Notifications = _builder.build()
...
@kotlin.jvm.JvmSynthetic
inline fun pl.leancode.automatorserver.contracts.Contracts.Notifications.copy(block: pl.leancode.automatorserver.contracts.NotificationsKt.Dsl.() -> kotlin.Unit): pl.leancode.automatorserver.contracts.Contracts.Notifications =
  pl.leancode.automatorserver.contracts.NotificationsKt.Dsl._create(this.toBuilder()).apply { block() }._build()
