...
|---|---|---|
| [patrol-setup](patrol-setup/SKILL.md) | Set up Patrol E2E testing in a Flutter project for the first time — pubspec `patrol` block, native Android/iOS wiring, a first passing test, and optional Patrol MCP setup. | Set up Patrol in this project and get a first test passing |
