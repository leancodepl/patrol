...
| [test flutter beta channel][test-flutter-beta] | Weekly (Monday at 02:00 UTC), manual | Pixel7 | 35 | Flutter beta | — | Runs smoke test on Flutter beta channel using `example_test.dart` to verify Patrol compatibility with beta Flutter releases. |
...
- **Weekly (Monday at 02:00 UTC)**: [test flutter beta channel][test-flutter-beta]
