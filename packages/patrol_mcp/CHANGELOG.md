...
- Simplified setup: the `run-patrol` wrapper script is no longer needed — point your MCP config directly at `dart run patrol_mcp`. FVM projects are detected automatically. See the README for the updated setup.
