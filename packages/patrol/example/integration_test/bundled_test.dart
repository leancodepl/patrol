...
Future<void> main() async {
  ...
  PatrolBinding.ensureInitialized().nativeAutomator = nativeAutomator;
  ...
  final completer = Completer<DartTestGroup>();
  ...
  test('patrol_test_explorer', () {
    ...
    completer.complete(dartTestGroup);
  });
  ...
  unawaited(runAppService(testGroup: dartTestGroup));

  // Until now, the PatrolJUnit runner was waiting for us (the Dart side) to
  // come alive. Now that we did, let's notify it by creating a one-off
  // NativeAutomator.
  print('NativeAutomator.markAppReady() called');
