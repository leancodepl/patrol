...
import pl.leancode.patrol.example.contracts.Contracts
import pl.leancode.patrol.example.contracts.Contracts.EnterTextRequest.FindByCase.INDEX
import pl.leancode.patrol.example.contracts.Contracts.EnterTextRequest.FindByCase.SELECTOR
import pl.leancode.patrol.example.contracts.Contracts.HandlePermissionRequest.Code.DENIED
import pl.leancode.patrol.example.contracts.Contracts.HandlePermissionRequest.Code.ONLY_THIS_TIME
import pl.leancode.patrol.example.contracts.Contracts.HandlePermissionRequest.Code.WHILE_USING
import pl.leancode.patrol.example.contracts.Contracts.SetLocationAccuracyRequest.LocationAccuracy.COARSE
import pl.leancode.patrol.example.contracts.Contracts.SetLocationAccuracyRequest.LocationAccuracy.FINE
import pl.leancode.patrol.example.contracts.NativeAutomatorGrpcKt
import pl.leancode.patrol.example.contracts.empty
import pl.leancode.patrol.example.contracts.getNativeViewsResponse
import pl.leancode.patrol.example.contracts.getNotificationsResponse
import pl.leancode.patrol.example.contracts.permissionDialogVisibleResponse
