...
internal protocol Patrol_PatrolAppServiceClientInterceptorFactoryProtocol: Sendable {
...
extension Patrol_NativeAutomatorClientProtocol {
  ...
  /// Unary call to initialize
  ///
  /// - Parameters:
  ///   - request: Request to send to initialize.
  ///   - callOptions: Call options.
  /// - Returns: A `UnaryCall` with futures for the metadata, status and response.
  internal func initialize(
    ...
    return self.makeUnaryCall(
      path: Patrol_NativeAutomatorClientMetadata.Methods.initialize.path,
      request: request,
      callOptions: callOptions ?? self.defaultCallOptions,
      interceptors: self.interceptors?.makeinitializeInterceptors() ?? []
    )
  }
...
extension Patrol_NativeAutomatorAsyncClientProtocol {
  ...
  internal func makeInitializeCall(
    _ request: Patrol_Empty,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<Patrol_Empty, Patrol_Empty> {
    return self.makeAsyncUnaryCall(
...
internal protocol Patrol_NativeAutomatorClientInterceptorFactoryProtocol: Sendable {

  /// - Returns: Interceptors to use when invoking 'initialize'.
  func makeinitializeInterceptors() -> [ClientInterceptor<Patrol_Empty, Patrol_Empty>]
...
internal enum Patrol_NativeAutomatorClientMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    ...
    methods: [
      Patrol_NativeAutomatorClientMetadata.Methods.initialize,
  ...
  internal enum Methods {
    internal static let initialize = GRPCMethodDescriptor(
      name: "initialize",
      path: "/patrol.NativeAutomator/initialize",
      type: GRPCCallType.unary
    )
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
internal protocol Patrol_PatrolAppServiceAsyncProvider: CallHandlerProvider, Sendable {
  static var serviceDescriptor: GRPCServiceDescriptor { get }
  var interceptors: Patrol_PatrolAppServiceServerInterceptorFactoryProtocol? { get }
  ...
  internal func handle(
    ...
    case "listDartTests":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_ListDartTestsResponse>(),
        interceptors: self.interceptors?.makelistDartTestsInterceptors() ?? [],
        wrapping: { try await self.listDartTests(request: $0, context: $1) }
      )
    ...
    case "runDartTest":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_RunDartTestResponse>(),
        interceptors: self.interceptors?.makerunDartTestInterceptors() ?? [],
        wrapping: { try await self.runDartTest(request: $0, context: $1) }
      )
...
internal protocol Patrol_PatrolAppServiceServerInterceptorFactoryProtocol: Sendable {

  /// - Returns: Interceptors to use when handling 'listDartTests'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makelistDartTestsInterceptors() -> [ServerInterceptor<Patrol_Empty, Patrol_ListDartTestsResponse>]
...
internal protocol Patrol_NativeAutomatorProvider: CallHandlerProvider {
  ...
  func initialize(request: Patrol_Empty, context: StatusOnlyCallContext) -> EventLoopFuture<Patrol_Empty>
  ...
  internal func handle(
    ...
    case "initialize":
      return UnaryServerHandler(
        ...
        interceptors: self.interceptors?.makeinitializeInterceptors() ?? [],
        userFunction: self.initialize(request:context:)
      )
...
/// To implement a server, implement an object which conforms to this protocol.
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
internal protocol Patrol_NativeAutomatorAsyncProvider: CallHandlerProvider, Sendable {
  static var serviceDescriptor: GRPCServiceDescriptor { get }
  var interceptors: Patrol_NativeAutomatorServerInterceptorFactoryProtocol? { get }
  ...
  internal func handle(
    ...
    case "initialize":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.makeinitializeInterceptors() ?? [],
        wrapping: { try await self.initialize(request: $0, context: $1) }
      )
    ...
    case "pressHome":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.makepressHomeInterceptors() ?? [],
        wrapping: { try await self.pressHome(request: $0, context: $1) }
      )
    ...
    case "pressBack":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.makepressBackInterceptors() ?? [],
        wrapping: { try await self.pressBack(request: $0, context: $1) }
      )
    ...
    case "pressRecentApps":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.makepressRecentAppsInterceptors() ?? [],
        wrapping: { try await self.pressRecentApps(request: $0, context: $1) }
      )
    ...
    case "doublePressRecentApps":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.makedoublePressRecentAppsInterceptors() ?? [],
        wrapping: { try await self.doublePressRecentApps(request: $0, context: $1) }
      )
    ...
    case "openApp":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.makeopenAppInterceptors() ?? [],
        wrapping: { try await self.openApp(request: $0, context: $1) }
      )
    ...
    case "openQuickSettings":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.makeopenQuickSettingsInterceptors() ?? [],
        wrapping: { try await self.openQuickSettings(request: $0, context: $1) }
      )
    ...
    case "getNativeViews":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_GetNativeViewsResponse>(),
        interceptors: self.interceptors?.makegetNativeViewsInterceptors() ?? [],
        wrapping: { try await self.getNativeViews(request: $0, context: $1) }
      )
    ...
    case "tap":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.maketapInterceptors() ?? [],
        wrapping: { try await self.tap(request: $0, context: $1) }
      )
    ...
    case "doubleTap":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.makedoubleTapInterceptors() ?? [],
        wrapping: { try await self.doubleTap(request: $0, context: $1) }
      )
    ...
    case "enterText":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.makeenterTextInterceptors() ?? [],
        wrapping: { try await self.enterText(request: $0, context: $1) }
      )
    ...
    case "enableAirplaneMode":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.makeenableAirplaneModeInterceptors() ?? [],
        wrapping: { try await self.enableAirplaneMode(request: $0, context: $1) }
      )
    ...
    case "disableAirplaneMode":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.makedisableAirplaneModeInterceptors() ?? [],
        wrapping: { try await self.disableAirplaneMode(request: $0, context: $1) }
      )
    ...
    case "enableWiFi":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.makeenableWiFiInterceptors() ?? [],
        wrapping: { try await self.enableWiFi(request: $0, context: $1) }
      )
    ...
    case "disableWiFi":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.makedisableWiFiInterceptors() ?? [],
        wrapping: { try await self.disableWiFi(request: $0, context: $1) }
      )
    ...
    case "enableCellular":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.makeenableCellularInterceptors() ?? [],
        wrapping: { try await self.enableCellular(request: $0, context: $1) }
      )
    ...
    case "disableCellular":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.makedisableCellularInterceptors() ?? [],
        wrapping: { try await self.disableCellular(request: $0, context: $1) }
      )
    ...
    case "enableBluetooth":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.makeenableBluetoothInterceptors() ?? [],
        wrapping: { try await self.enableBluetooth(request: $0, context: $1) }
      )
    ...
    case "disableBluetooth":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.makedisableBluetoothInterceptors() ?? [],
        wrapping: { try await self.disableBluetooth(request: $0, context: $1) }
      )
    ...
    case "enableDarkMode":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.makeenableDarkModeInterceptors() ?? [],
        wrapping: { try await self.enableDarkMode(request: $0, context: $1) }
      )
    ...
    case "disableDarkMode":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.makedisableDarkModeInterceptors() ?? [],
        wrapping: { try await self.disableDarkMode(request: $0, context: $1) }
      )
    ...
    case "openNotifications":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.makeopenNotificationsInterceptors() ?? [],
        wrapping: { try await self.openNotifications(request: $0, context: $1) }
      )
    ...
    case "closeNotifications":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.makecloseNotificationsInterceptors() ?? [],
        wrapping: { try await self.closeNotifications(request: $0, context: $1) }
      )
    ...
    case "closeHeadsUpNotification":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.makecloseHeadsUpNotificationInterceptors() ?? [],
        wrapping: { try await self.closeHeadsUpNotification(request: $0, context: $1) }
      )
    ...
    case "tapOnNotification":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.maketapOnNotificationInterceptors() ?? [],
        wrapping: { try await self.tapOnNotification(request: $0, context: $1) }
      )
    ...
    case "isPermissionDialogVisible":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_PermissionDialogVisibleResponse>(),
        interceptors: self.interceptors?.makeisPermissionDialogVisibleInterceptors() ?? [],
        wrapping: { try await self.isPermissionDialogVisible(request: $0, context: $1) }
      )
    ...
    case "handlePermissionDialog":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.makehandlePermissionDialogInterceptors() ?? [],
        wrapping: { try await self.handlePermissionDialog(request: $0, context: $1) }
      )
    ...
    case "setLocationAccuracy":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.makesetLocationAccuracyInterceptors() ?? [],
        wrapping: { try await self.setLocationAccuracy(request: $0, context: $1) }
      )
    ...
    case "debug":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.makedebugInterceptors() ?? [],
        wrapping: { try await self.debug(request: $0, context: $1) }
      )
    ...
    case "markPatrolAppServiceReady":
      return GRPCAsyncServerHandler(
        ...
        responseSerializer: ProtobufSerializer<Patrol_Empty>(),
        interceptors: self.interceptors?.makemarkPatrolAppServiceReadyInterceptors() ?? [],
        wrapping: { try await self.markPatrolAppServiceReady(request: $0, context: $1) }
      )
...
internal protocol Patrol_NativeAutomatorServerInterceptorFactoryProtocol: Sendable {

  /// - Returns: Interceptors to use when handling 'initialize'.
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeinitializeInterceptors() -> [ServerInterceptor<Patrol_Empty, Patrol_Empty>]
...
internal enum Patrol_NativeAutomatorServerMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    ...
    fullName: "patrol.NativeAutomator",
    methods: [
      Patrol_NativeAutomatorServerMetadata.Methods.initialize,
