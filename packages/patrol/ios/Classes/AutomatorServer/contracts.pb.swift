...
public struct Patrol_ListDartTestsResponse {
...
public struct Patrol_DartGroupEntry {
  ...
  public var encodedFullName: String = String()
...
public struct Patrol_RunDartTestResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Patrol_ListDartTestsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ListDartTestsResponse"
  ...
  public static func ==(lhs: Patrol_ListDartTestsResponse, rhs: Patrol_ListDartTestsResponse) -> Bool {
...
extension Patrol_DartGroupEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularStringField(value: &self.encodedFullName) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.encodedFullName.isEmpty {
      try visitor.visitSingularStringField(value: self.encodedFullName, fieldNumber: 3)
    }
    if self.type != .group {
  ...
  public static func ==(lhs: Patrol_DartGroupEntry, rhs: Patrol_DartGroupEntry) -> Bool {
    ...
    if lhs.encodedFullName != rhs.encodedFullName {return false}
...
extension Patrol_RunDartTestRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".RunDartTestRequest"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
  ]
  ...
  public static func ==(lhs: Patrol_RunDartTestRequest, rhs: Patrol_RunDartTestRequest) -> Bool {
    if lhs.name != rhs.name {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Patrol_RunDartTestResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
extension Patrol_RunDartTestResponse.Result: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
