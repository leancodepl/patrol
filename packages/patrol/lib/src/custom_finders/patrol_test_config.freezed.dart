...
class _$_PatrolTestConfig implements _PatrolTestConfig {
  ...
  @override
  String toString() {
    return 'PatrolTestConfig(existsTimeout: $existsTimeout, visibleTimeout: $visibleTimeout, settleTimeout: $settleTimeout, andSettle: $andSettle, appName: $appName)';
  }
...
abstract class _PatrolTestConfig implements PatrolTestConfig {
  const factory _PatrolTestConfig(
      ...
      final Duration settleTimeout,
      final bool andSettle,
      final String? appName}) = _$_PatrolTestConfig;
