...
IOSGetNativeUITreeRequest _$IOSGetNativeUITreeRequestFromJson(
  Map<String, dynamic> json,
) => IOSGetNativeUITreeRequest(
  iosInstalledApps: (json['iosInstalledApps'] as List<dynamic>?)
      ?.map((e) => e as String)
      .toList(),
);

Map<String, dynamic> _$IOSGetNativeUITreeRequestToJson(
  IOSGetNativeUITreeRequest instance,
) => <String, dynamic>{'iosInstalledApps': instance.iosInstalledApps};
...
AndroidGetNativeUITreeResponse _$AndroidGetNativeUITreeResponseFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$AndroidGetNativeUITreeResponseToJson(
  AndroidGetNativeUITreeResponse instance,
) => <String, dynamic>{'roots': instance.roots.map((e) => e.toJson()).toList()};

IOSGetNativeUITreeResponse _$IOSGetNativeUITreeResponseFromJson(
  Map<String, dynamic> json,
) => IOSGetNativeUITreeResponse(
  roots: (json['roots'] as List<dynamic>)
      .map((e) => IOSNativeView.fromJson(e as Map<String, dynamic>))
      .toList(),
);

Map<String, dynamic> _$IOSGetNativeUITreeResponseToJson(
  IOSGetNativeUITreeResponse instance,
) => <String, dynamic>{'roots': instance.roots.map((e) => e.toJson()).toList()};
