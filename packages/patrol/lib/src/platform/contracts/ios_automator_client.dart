...
class IosAutomatorClient {
  ...
  Future<void> openPlatformApp(
    IOSOpenPlatformAppRequest request,
  ) {
    return _sendRequest(
      'openPlatformApp',
      request.toJson(),
  ...
  Future<void> waitUntilVisible(
    IOSWaitUntilVisibleRequest request,
  ) {
    return _sendRequest(
      'waitUntilVisible',
      request.toJson(),
  ...
  Future<void> tapOnNotification(
    IOSTapOnNotificationRequest request,
  ) {
    return _sendRequest(
      'tapOnNotification',
      request.toJson(),
  ...
  Future<void> takeCameraPhoto(
    IOSTakeCameraPhotoRequest request,
  ) {
    return _sendRequest(
      'takeCameraPhoto',
      request.toJson(),
  ...
  Future<void> pickImageFromGallery(
    IOSPickImageFromGalleryRequest request,
  ) {
    return _sendRequest(
