...
class AndroidAutomatorClient {
  ...
  Future<void> openPlatformApp(
    AndroidOpenPlatformAppRequest request,
  ) {
    return _sendRequest(
      'openPlatformApp',
      request.toJson(),
  ...
  Future<void> enterText(
    AndroidEnterTextRequest request,
  ) {
    return _sendRequest(
      'enterText',
      request.toJson(),
  ...
  Future<void> waitUntilVisible(
    AndroidWaitUntilVisibleRequest request,
  ) {
    return _sendRequest(
      'waitUntilVisible',
      request.toJson(),
  ...
  Future<void> tapOnNotification(
    AndroidTapOnNotificationRequest request,
  ) {
    return _sendRequest(
      'tapOnNotification',
      request.toJson(),
  ...
  Future<void> takeCameraPhoto(
    AndroidTakeCameraPhotoRequest request,
  ) {
    return _sendRequest(
      'takeCameraPhoto',
      request.toJson(),
