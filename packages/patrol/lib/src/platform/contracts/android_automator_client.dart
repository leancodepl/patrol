...
class AndroidAutomatorClient {
  ...
  Future<AndroidGetNativeUITreeResponse> getNativeUITree() async {
    final json = await _sendRequest('getNativeUITree');
    return AndroidGetNativeUITreeResponse.fromJson(json);
  }
