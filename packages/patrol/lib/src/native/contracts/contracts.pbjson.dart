...
const ListDartTestsResponse$json = const {
  ...
  '2': const [
    const {'1': 'group', '3': 1, '4': 1, '5': 11, '6': '.patrol.DartTestGroup', '10': 'group'},
  ],
};
...
const DartTestGroup$json = const {
  ...
  '2': const [
    ...
    const {'1': 'tests', '3': 2, '4': 3, '5': 11, '6': '.patrol.DartTestCase', '10': 'tests'},
    const {'1': 'groups', '3': 3, '4': 3, '5': 11, '6': '.patrol.DartTestGroup', '10': 'groups'},
  ],
};
...
final $typed_data.Uint8List dartTestCaseDescriptor = $convert.base64Decode('CgxEYXJ0VGVzdENhc2USEgoEbmFtZRgBIAEoCVIEbmFtZQ==');
...
final $typed_data.Uint8List getNativeViewsRequestDescriptor = $convert.base64Decode('ChVHZXROYXRpdmVWaWV3c1JlcXVlc3QSLAoIc2VsZWN0b3IYASABKAsyEC5wYXRyb2wuU2VsZWN0b3JSCHNlbGVjdG9yEhQKBWFwcElkGAIgASgJUgVhcHBJZA==');
...
const EnterTextRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'keyboardBehavior', '3': 5, '4': 1, '5': 14, '6': '.patrol.EnterTextRequest.KeyboardBehavior', '10': 'keyboardBehavior'},
  ],
...
final $typed_data.Uint8List waitUntilVisibleRequestDescriptor = $convert.base64Decode('ChdXYWl0VW50aWxWaXNpYmxlUmVxdWVzdBIsCghzZWxlY3RvchgBIAEoCzIQLnBhdHJvbC5TZWxlY3RvclIIc2VsZWN0b3ISFAoFYXBwSWQYAiABKAlSBWFwcElk');
