...
final $typed_data.Uint8List openAppCommandDescriptor = $convert
    .base64Decode('Cg5PcGVuQXBwQ29tbWFuZBIUCgVhcHBJZBgBIAEoCVIFYXBwSWQ=');
...
final $typed_data.Uint8List tapCommandDescriptor = $convert.base64Decode(
    'CgpUYXBDb21tYW5kEhQKBWFwcElkGAEgASgJUgVhcHBJZBIsCghzZWxlY3RvchgCIAEoCzIQLnBhdHJvbC5TZWxlY3RvclIIc2VsZWN0b3I=');
...
final $typed_data.Uint8List doubleTapCommandDescriptor = $convert.base64Decode(
    'ChBEb3VibGVUYXBDb21tYW5kEhQKBWFwcElkGAEgASgJUgVhcHBJZBIsCghzZWxlY3RvchgCIAEoCzIQLnBhdHJvbC5TZWxlY3RvclIIc2VsZWN0b3I=');
...
final $typed_data.Uint8List enterTextBySelectorCommandDescriptor =
    $convert.base64Decode(
        'ChpFbnRlclRleHRCeVNlbGVjdG9yQ29tbWFuZBIUCgVhcHBJZBgBIAEoCVIFYXBwSWQSEgoEZGF0YRgCIAEoCVIEZGF0YRIsCghzZWxlY3RvchgDIAEoCzIQLnBhdHJvbC5TZWxlY3RvclIIc2VsZWN0b3I=');
...
final $typed_data.Uint8List enterTextByIndexCommandDescriptor =
    $convert.base64Decode(
        'ChdFbnRlclRleHRCeUluZGV4Q29tbWFuZBIUCgVhcHBJZBgBIAEoCVIFYXBwSWQSEgoEZGF0YRgCIAEoCVIEZGF0YRIUCgVpbmRleBgDIAEoDVIFaW5kZXg=');
...
final $typed_data.Uint8List tapOnNotificationByIndexCommandDescriptor =
    $convert.base64Decode(
        'Ch9UYXBPbk5vdGlmaWNhdGlvbkJ5SW5kZXhDb21tYW5kEhQKBWluZGV4GAEgASgNUgVpbmRleA==');
...
final $typed_data.Uint8List tapOnNotificationBySelectorCommandDescriptor =
    $convert.base64Decode(
        'CiJUYXBPbk5vdGlmaWNhdGlvbkJ5U2VsZWN0b3JDb21tYW5kEiwKCHNlbGVjdG9yGAEgASgLMhAucGF0cm9sLlNlbGVjdG9yUghzZWxlY3Rvcg==');
...
final $typed_data.Uint8List swipeCommandDescriptor = $convert.base64Decode(
    'CgxTd2lwZUNvbW1hbmQSFgoGc3RhcnRYGAEgASgCUgZzdGFydFgSFgoGc3RhcnRZGAIgASgCUgZzdGFydFkSEgoEZW5kWBgDIAEoAlIEZW5kWBISCgRlbmRZGAQgASgCUgRlbmRZEhQKBXN0ZXBzGAUgASgNUgVzdGVwcw==');
...
const HandlePermissionCommand$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.patrol.HandlePermissionCommand.Code',
      '10': 'code'
    },
  ],
...
final $typed_data.Uint8List handlePermissionCommandDescriptor =
    $convert.base64Decode(
        'ChdIYW5kbGVQZXJtaXNzaW9uQ29tbWFuZBI4CgRjb2RlGAEgASgOMiQucGF0cm9sLkhhbmRsZVBlcm1pc3Npb25Db21tYW5kLkNvZGVSBGNvZGUiNwoEQ29kZRIPCgtXSElMRV9VU0lORxAAEhIKDk9OTFlfVEhJU19USU1FEAESCgoGREVOSUVEEAI=');
...
final $typed_data.Uint8List nativeWidgetsQueryDescriptor = $convert.base64Decode(
    'ChJOYXRpdmVXaWRnZXRzUXVlcnkSLAoIc2VsZWN0b3IYASABKAsyEC5wYXRyb2wuU2VsZWN0b3JSCHNlbGVjdG9y');
...
final $typed_data.Uint8List notificationsQueryResponseDescriptor =
    $convert.base64Decode(
        'ChpOb3RpZmljYXRpb25zUXVlcnlSZXNwb25zZRI6Cg1ub3RpZmljYXRpb25zGAEgAygLMhQucGF0cm9sLk5vdGlmaWNhdGlvblINbm90aWZpY2F0aW9ucw==');
...
final $typed_data.Uint8List nativeWidgetsQueryResponseDescriptor =
    $convert.base64Decode(
        'ChpOYXRpdmVXaWRnZXRzUXVlcnlSZXNwb25zZRI6Cg1uYXRpdmVXaWRnZXRzGAEgAygLMhQucGF0cm9sLk5hdGl2ZVdpZGdldFINbmF0aXZlV2lkZ2V0cw==');
