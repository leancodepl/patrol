...
final $typed_data.Uint8List pressHomeRequestDescriptor = $convert.base64Decode('ChBQcmVzc0hvbWVSZXF1ZXN0');
...
final $typed_data.Uint8List pressHomeResponseDescriptor = $convert.base64Decode('ChFQcmVzc0hvbWVSZXNwb25zZQ==');
...
final $typed_data.Uint8List pressBackRequestDescriptor = $convert.base64Decode('ChBQcmVzc0JhY2tSZXF1ZXN0');
...
final $typed_data.Uint8List pressBackResponseDescriptor = $convert.base64Decode('ChFQcmVzc0JhY2tSZXNwb25zZQ==');
...
final $typed_data.Uint8List pressRecentAppsRequestDescriptor = $convert.base64Decode('ChZQcmVzc1JlY2VudEFwcHNSZXF1ZXN0');
...
final $typed_data.Uint8List pressRecentAppsResponseDescriptor = $convert.base64Decode('ChdQcmVzc1JlY2VudEFwcHNSZXNwb25zZQ==');
...
final $typed_data.Uint8List doublePressRecentAppsRequestDescriptor = $convert.base64Decode('ChxEb3VibGVQcmVzc1JlY2VudEFwcHNSZXF1ZXN0');
...
final $typed_data.Uint8List doublePressRecentAppsResponseDescriptor = $convert.base64Decode('Ch1Eb3VibGVQcmVzc1JlY2VudEFwcHNSZXNwb25zZQ==');
...
final $typed_data.Uint8List openAppResponseDescriptor = $convert.base64Decode('Cg9PcGVuQXBwUmVzcG9uc2U=');
...
final $typed_data.Uint8List openNotificationsRequestDescriptor = $convert.base64Decode('ChhPcGVuTm90aWZpY2F0aW9uc1JlcXVlc3Q=');
...
final $typed_data.Uint8List openNotificationsResponseDescriptor = $convert.base64Decode('ChlPcGVuTm90aWZpY2F0aW9uc1Jlc3BvbnNl');
...
final $typed_data.Uint8List tapOnNotificationResponseDescriptor = $convert.base64Decode('ChlUYXBPbk5vdGlmaWNhdGlvblJlc3BvbnNl');
...
final $typed_data.Uint8List openQuickSettingsResponseDescriptor = $convert.base64Decode('ChlPcGVuUXVpY2tTZXR0aW5nc1Jlc3BvbnNl');
...
final $typed_data.Uint8List darkModeResponseDescriptor = $convert.base64Decode('ChBEYXJrTW9kZVJlc3BvbnNl');
...
final $typed_data.Uint8List wiFiResponseDescriptor = $convert.base64Decode('CgxXaUZpUmVzcG9uc2U=');
...
final $typed_data.Uint8List cellularResponseDescriptor = $convert.base64Decode('ChBDZWxsdWxhclJlc3BvbnNl');
...
final $typed_data.Uint8List getNativeWidgetsRequestDescriptor = $convert.base64Decode('ChdHZXROYXRpdmVXaWRnZXRzUmVxdWVzdBIsCghzZWxlY3RvchgBIAEoCzIQLnBhdHJvbC5TZWxlY3RvclIIc2VsZWN0b3I=');
...
final $typed_data.Uint8List getNativeWidgetsResponseDescriptor = $convert.base64Decode('ChhHZXROYXRpdmVXaWRnZXRzUmVzcG9uc2USOgoNbmF0aXZlV2lkZ2V0cxgBIAMoCzIULnBhdHJvbC5OYXRpdmVXaWRnZXRSDW5hdGl2ZVdpZGdldHM=');
...
final $typed_data.Uint8List getNotificationsResponseDescriptor = $convert.base64Decode('ChhHZXROb3RpZmljYXRpb25zUmVzcG9uc2USOgoNbm90aWZpY2F0aW9ucxgBIAMoCzIULnBhdHJvbC5Ob3RpZmljYXRpb25SDW5vdGlmaWNhdGlvbnM=');
...
final $typed_data.Uint8List tapRequestDescriptor = $convert.base64Decode('CgpUYXBSZXF1ZXN0EiwKCFNlbGVjdG9yGAEgASgLMhAucGF0cm9sLlNlbGVjdG9yUghTZWxlY3RvchIUCgVhcHBJZBgCIAEoCVIFYXBwSWQ=');
...
final $typed_data.Uint8List tapResponseDescriptor = $convert.base64Decode('CgtUYXBSZXNwb25zZQ==');
...
final $typed_data.Uint8List enterTextResponseDescriptor = $convert.base64Decode('ChFFbnRlclRleHRSZXNwb25zZQ==');
...
final $typed_data.Uint8List swipeResponseDescriptor = $convert.base64Decode('Cg1Td2lwZVJlc3BvbnNl');
...
final $typed_data.Uint8List handlePermissionResponseDescriptor = $convert.base64Decode('ChhIYW5kbGVQZXJtaXNzaW9uUmVzcG9uc2U=');
...
final $typed_data.Uint8List setLocationAccuracyResponseDescriptor = $convert.base64Decode('ChtTZXRMb2NhdGlvbkFjY3VyYWN5UmVzcG9uc2U=');
