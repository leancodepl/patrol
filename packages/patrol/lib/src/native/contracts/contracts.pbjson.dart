...
const ListDartTestsResponse$json = {
  ...
  '2': [
    {'1': 'group', '3': 1, '4': 1, '5': 11, '6': '.patrol.DartTestGroup', '10': 'group'},
  ],
};
...
const DartTestGroup$json = {
  ...
  '2': [
    ...
    {'1': 'tests', '3': 2, '4': 3, '5': 11, '6': '.patrol.DartTestCase', '10': 'tests'},
    {'1': 'groups', '3': 3, '4': 3, '5': 11, '6': '.patrol.DartTestGroup', '10': 'groups'},
  ],
};
...
final $typed_data.Uint8List dartTestCaseDescriptor = $convert.base64Decode(
    'CgxEYXJ0VGVzdENhc2USEgoEbmFtZRgBIAEoCVIEbmFtZQ==');
...
final $typed_data.Uint8List runDartTestRequestDescriptor = $convert.base64Decode(
    'ChJSdW5EYXJ0VGVzdFJlcXVlc3QSEgoEbmFtZRgBIAEoCVIEbmFtZQ==');

@$core.Deprecated('Use runDartTestResponseDescriptor instead')
const RunDartTestResponse$json = {
  '1': 'RunDartTestResponse',
  '2': [
    {'1': 'result', '3': 1, '4': 1, '5': 14, '6': '.patrol.RunDartTestResponse.Result', '10': 'result'},
    {'1': 'details', '3': 2, '4': 1, '5': 9, '9': 0, '10': 'details', '17': true},
  ],
...
const ConfigureRequest$json = {
  '1': 'ConfigureRequest',
  '2': [
    {'1': 'findTimeoutMillis', '3': 1, '4': 1, '5': 4, '10': 'findTimeoutMillis'},
  ],
};
...
final $typed_data.Uint8List openAppRequestDescriptor = $convert.base64Decode(
    'Cg5PcGVuQXBwUmVxdWVzdBIUCgVhcHBJZBgBIAEoCVIFYXBwSWQ=');
...
const TapOnNotificationRequest$json = {
  ...
  '2': [
    ...
    {'1': 'selector', '3': 2, '4': 1, '5': 11, '6': '.patrol.Selector', '9': 0, '10': 'selector'},
  ],
  '8': [
    {'1': 'findBy'},
  ],
...
final $typed_data.Uint8List tapOnNotificationRequestDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List openQuickSettingsRequestDescriptor = $convert.base64Decode(
    'ChhPcGVuUXVpY2tTZXR0aW5nc1JlcXVlc3Q=');
...
final $typed_data.Uint8List darkModeRequestDescriptor = $convert.base64Decode(
    'Cg9EYXJrTW9kZVJlcXVlc3QSFAoFYXBwSWQYASABKAlSBWFwcElk');

@$core.Deprecated('Use getNativeViewsRequestDescriptor instead')
const GetNativeViewsRequest$json = {
  '1': 'GetNativeViewsRequest',
  '2': [
    {'1': 'selector', '3': 1, '4': 1, '5': 11, '6': '.patrol.Selector', '10': 'selector'},
  ],
};
...
const GetNativeViewsResponse$json = {
  ...
  '2': [
    {'1': 'nativeViews', '3': 2, '4': 3, '5': 11, '6': '.patrol.NativeView', '10': 'nativeViews'},
  ],
};

/// Descriptor for `GetNativeViewsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getNativeViewsResponseDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List getNotificationsRequestDescriptor = $convert.base64Decode(
    'ChdHZXROb3RpZmljYXRpb25zUmVxdWVzdA==');
...
const GetNotificationsResponse$json = {
  ...
  '2': [
    {'1': 'notifications', '3': 2, '4': 3, '5': 11, '6': '.patrol.Notification', '10': 'notifications'},
  ],
};
...
const EnterTextRequest$json = {
  ...
  '2': [
    ...
    {'1': 'selector', '3': 4, '4': 1, '5': 11, '6': '.patrol.Selector', '9': 0, '10': 'selector'},
  ],
  '8': [
    {'1': 'findBy'},
  ],
...
final $typed_data.Uint8List enterTextRequestDescriptor = $convert.base64Decode(
    ...
    'LlNlbGVjdG9ySABSCHNlbGVjdG9yQggKBmZpbmRCeQ==');
...
const HandlePermissionRequest$json = {
  ...
  '2': [
    {'1': 'code', '3': 1, '4': 1, '5': 14, '6': '.patrol.HandlePermissionRequest.Code', '10': 'code'},
  ],
...
const SetLocationAccuracyRequest$json = {
  ...
  '2': [
    {'1': 'locationAccuracy', '3': 1, '4': 1, '5': 14, '6': '.patrol.SetLocationAccuracyRequest.LocationAccuracy', '10': 'locationAccuracy'},
  ],
...
final $typed_data.Uint8List permissionDialogVisibleRequestDescriptor = $convert.base64Decode(
...
final $typed_data.Uint8List permissionDialogVisibleResponseDescriptor = $convert.base64Decode(
...
const Selector$json = {
  ...
  '2': [
    ...
    {'1': 'textStartsWith', '3': 2, '4': 1, '5': 9, '9': 1, '10': 'textStartsWith', '17': true},
    {'1': 'textContains', '3': 3, '4': 1, '5': 9, '9': 2, '10': 'textContains', '17': true},
    {'1': 'className', '3': 4, '4': 1, '5': 9, '9': 3, '10': 'className', '17': true},
    {'1': 'contentDescription', '3': 5, '4': 1, '5': 9, '9': 4, '10': 'contentDescription', '17': true},
    {'1': 'contentDescriptionStartsWith', '3': 6, '4': 1, '5': 9, '9': 5, '10': 'contentDescriptionStartsWith', '17': true},
    {'1': 'contentDescriptionContains', '3': 7, '4': 1, '5': 9, '9': 6, '10': 'contentDescriptionContains', '17': true},
    {'1': 'resourceId', '3': 8, '4': 1, '5': 9, '9': 7, '10': 'resourceId', '17': true},
    {'1': 'instance', '3': 9, '4': 1, '5': 13, '9': 8, '10': 'instance', '17': true},
    {'1': 'enabled', '3': 10, '4': 1, '5': 8, '9': 9, '10': 'enabled', '17': true},
    {'1': 'focused', '3': 11, '4': 1, '5': 8, '9': 10, '10': 'focused', '17': true},
...
const NativeView$json = {
  ...
  '2': [
    ...
    {'1': 'contentDescription', '3': 3, '4': 1, '5': 9, '10': 'contentDescription'},
    ...
    {'1': 'applicationPackage', '3': 8, '4': 1, '5': 9, '10': 'applicationPackage'},
    {'1': 'children', '3': 9, '4': 3, '5': 11, '6': '.patrol.NativeView', '10': 'children'},
  ],
};
...
const Notification$json = {
  '1': 'Notification',
  '2': [
    {'1': 'appName', '3': 1, '4': 1, '5': 9, '9': 0, '10': 'appName', '17': true},
...
const SubmitTestResultsRequest$json = {
  ...
  '2': [
    {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.patrol.SubmitTestResultsRequest.ResultsEntry', '10': 'results'},
  ],
