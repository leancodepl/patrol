...
class EnterTextRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EnterTextRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'patrol'), createEmptyInstance: create)
    ...
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'showKeyboard', protoName: 'showKeyboard')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  set showKeyboard($core.bool v) { $_setBool(4, v); }
  @$pb.TagNumber(5)
...
class WaitUntilVisibleRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WaitUntilVisibleRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'patrol'), createEmptyInstance: create)
    ..aOM<Selector>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'selector', subBuilder: Selector.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'appId', protoName: 'appId')
    ..hasRequiredFields = false
  ;
  ...
  factory WaitUntilVisibleRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory WaitUntilVisibleRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  WaitUntilVisibleRequest clone() => WaitUntilVisibleRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  WaitUntilVisibleRequest copyWith(void Function(WaitUntilVisibleRequest) updates) => super.copyWith((message) => updates(message as WaitUntilVisibleRequest)) as WaitUntilVisibleRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static WaitUntilVisibleRequest create() => WaitUntilVisibleRequest._();
  WaitUntilVisibleRequest createEmptyInstance() => create();
  static $pb.PbList<WaitUntilVisibleRequest> createRepeated() => $pb.PbList<WaitUntilVisibleRequest>();
  @$core.pragma('dart2js:noInline')
  static WaitUntilVisibleRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<WaitUntilVisibleRequest>(create);
