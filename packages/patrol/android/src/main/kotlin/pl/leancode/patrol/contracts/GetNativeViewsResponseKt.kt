...
public object GetNativeViewsResponseKt {
  ...
  public class Dsl private constructor(
     ...
     */
     public val nativeViews: com.google.protobuf.kotlin.DslList<pl.leancode.patrol.contracts.Contracts.NativeView, NativeViewsProxy>
      @kotlin.jvm.JvmSynthetic
    ...
    public fun com.google.protobuf.kotlin.DslList<pl.leancode.patrol.contracts.Contracts.NativeView, NativeViewsProxy>.add(value: pl.leancode.patrol.contracts.Contracts.NativeView) {
    ...
    public inline operator fun com.google.protobuf.kotlin.DslList<pl.leancode.patrol.contracts.Contracts.NativeView, NativeViewsProxy>.plusAssign(value: pl.leancode.patrol.contracts.Contracts.NativeView) {
      add(value)
    }
    /**
     * <code>repeated .patrol.NativeView nativeViews = 2;</code>
    ...
    public fun com.google.protobuf.kotlin.DslList<pl.leancode.patrol.contracts.Contracts.NativeView, NativeViewsProxy>.addAll(values: kotlin.collections.Iterable<pl.leancode.patrol.contracts.Contracts.NativeView>) {
    ...
    @Suppress("NOTHING_TO_INLINE")
    public inline operator fun com.google.protobuf.kotlin.DslList<pl.leancode.patrol.contracts.Contracts.NativeView, NativeViewsProxy>.plusAssign(values: kotlin.collections.Iterable<pl.leancode.patrol.contracts.Contracts.NativeView>) {
      addAll(values)
    }
    /**
     * <code>repeated .patrol.NativeView nativeViews = 2;</code>
    ...
    public operator fun com.google.protobuf.kotlin.DslList<pl.leancode.patrol.contracts.Contracts.NativeView, NativeViewsProxy>.set(index: kotlin.Int, value: pl.leancode.patrol.contracts.Contracts.NativeView) {
    ...
    public fun com.google.protobuf.kotlin.DslList<pl.leancode.patrol.contracts.Contracts.NativeView, NativeViewsProxy>.clear() {
