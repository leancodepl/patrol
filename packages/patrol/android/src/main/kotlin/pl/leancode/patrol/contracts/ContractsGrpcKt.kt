...
public object NativeAutomatorGrpcKt {
  ...
  public val setDartTestsMethod: MethodDescriptor<Contracts.SetDartTestsRequest, Contracts.Empty>
    @JvmStatic
    get() = NativeAutomatorGrpc.getSetDartTestsMethod()
  ...
  public class NativeAutomatorCoroutineStub @JvmOverloads constructor(
     ...
     * @return The single response from the server.
     */
    public suspend fun setDartTests(request: Contracts.SetDartTestsRequest, headers: Metadata =
        Metadata()): Contracts.Empty = unaryRpc(
      channel,
      NativeAutomatorGrpc.getSetDartTestsMethod(),
      request,
      callOptions,
      headers
    )
  ...
  public abstract class NativeAutomatorCoroutineImplBase(
    ...
    /**
     * Returns the response to an RPC for patrol.NativeAutomator.setDartTests.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [Status].  If this method fails with a [java.util.concurrent.CancellationException], the RPC
     * will fail
     ...
     * @param request The request from the client.
     */
    public open suspend fun setDartTests(request: Contracts.SetDartTestsRequest): Contracts.Empty =
        throw
        StatusException(UNIMPLEMENTED.withDescription("Method patrol.NativeAutomator.setDartTests is unimplemented"))
    ...
    public final override fun bindService(): ServerServiceDefinition =
      ...
      .addMethod(unaryServerMethodDefinition(
      context = this.context,
      descriptor = NativeAutomatorGrpc.getSetDartTestsMethod(),
      implementation = ::setDartTests
    ))
      .addMethod(unaryServerMethodDefinition(
      context = this.context,
