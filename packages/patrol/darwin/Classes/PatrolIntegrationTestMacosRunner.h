...
// To edit it:
//  1. Remove the trailing backslashes: $ sed 's/\\$//' darwin/Classes/PatrolIntegrationTestMacosRunner.h
//  2. Paste its contents into the RunnerUITests.m in the RunnerUITests target
//  3. Make the changes, make sure it works
//  4. Re-add trailing backslashes: $ sed 's/$/\\/' darwin/Classes/PatrolIntegrationTestMacosRunner.h
