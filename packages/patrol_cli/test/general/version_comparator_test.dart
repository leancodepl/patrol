  ...
  group('VersionComparator', () {
    ...
    test(
      ...
      () {
        ...
        expect(compatibility('1.0.0', '1.0.0'), true);
        expect(compatibility('1.1.0', '1.0.0'), true);
        expect(compatibility('1.3.0', '1.0.0'), false);
        expect(compatibility('1.3.0', '2.0.0'), true);
      },
    );
    ...
    test(
      ...
      () {
        ...
        final packageVersions = [
          VersionRange(min: Version.parse('1.0.0')),
          VersionRange(
            min: Version.parse('1.5.0'),
            max: Version.parse('2.0.1'),
          ),
        ...
        expect(compatibility('1.0.0', '1.0.0'), true);
        expect(compatibility('1.1.0', '2.0.1'), true);
        expect(compatibility('1.2.1', '2.0.1'), true);
      },
    );
    ...
    test(
      ...
      () {
        ...
        expect(compatibility('1.0.0', '1.0.0'), true);
        expect(compatibility('1.3.0', '1.2.0'), true);
        expect(compatibility('1.1.0', '1.5.0'), false);
        expect(compatibility('1.3.0', '1.5.0'), true);
      },
    );
  });
}
