...
''');
    ...
    final webOpts = WebAppOptions(
      ...
      chromiumSandbox: stringArg('web-chromium-sandbox'),
      ...
      bypassCsp: stringArg('web-bypass-csp'),
      ignoreHttpsErrors: stringArg('web-ignore-https-errors'),
      ...
      acceptDownloads: stringArg('web-accept-downloads'),
    );
