...
class AndroidTestCodegen {
  ...
  String _render(
    ...
    for (var i = 0; i < tests.length; i++) {
      final test = tests[i];
      final methodName = _uniqueMethodName(test.dartName, i, usedNames);
  ...
  String _uniqueMethodName(String dartName, int index, Set<String> used) {
    ...
    // Prefer the clean name; only disambiguate on collision (two Dart names
    // that sanitize to the same identifier) with the stable manifest index.
    var name = sanitized;
