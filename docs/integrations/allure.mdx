...
If you're using Allure to report your test results, you can use the alternative

We decided not to package this runner together with Patrol because it'd make
Patrol depend on Allure.
...
```title="android/app/src/main/res/allure.properties"
