...
Maestro's custom finders are very powerful, and you might often be inclined to
find the widget you want in a variety of ways. While we're encouraging you to
explore and play with Maestro's custom finders, we are quite confident that keys
...
Then you can use it in your app's and tests' code like this:
