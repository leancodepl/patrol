...
1. Maestro workflows are defined in YAML
   ...
   constructs such as if statements and for loops. Building a Turing-complete
   language for testing on top of YAML is certainly an interesting idea – it
   lowers the entry barrier to writing tests for newcomers.
...
[Honey][honey] also has a very similar approach to Maestro and Fluttium, sharing
most of the same pros and cons.
