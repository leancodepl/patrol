...
1. Maestro workflows run much faster than Flutter integration tests, which
   Maestro uses. It is because Maestro doesn't recompile your app, but only
   inspects its accessibility tree.
