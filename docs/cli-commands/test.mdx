...
- Gradle (when testing on Android)
- `xcodebuild` (when testing on iOS/macOS)
- Playwright (when testing on web)
...
See the [test command documentation](/cli-commands/test#full-isolation-between-tests) for more details.
