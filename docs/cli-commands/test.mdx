...
For iOS testing, you can use the `--clear-package-data` flag to uninstall the app before running each test (except of the first one).
This helps ensure test isolation and reproducibility:
