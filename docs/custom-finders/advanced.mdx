...
The `scrollTo()` method is simple to use, yet very poweful. Here's how you'd use
...
3. If the target widget becomes visible withing timeout, it finishes, otherwise
