...
<Info>
     Using an AI coding agent? The [`patrol-setup` agent skill] walks it through the
     steps below and gets a first test passing on an Android emulator. See
     [agent skills] for the full list and install instructions.
</Info>
...
[`patrol-setup` agent skill]: https://github.com/leancodepl/patrol/tree/master/skills/patrol-setup
