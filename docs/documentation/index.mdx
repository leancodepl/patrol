    ...
    <Accordion id="ios-setup" title="iOS setup">
      <Steps>
        ...
        <Step id="configure-runner-uitests">
          ...
          <Info>
            The `PatrolRunner` import is what makes this work under Swift Package Manager,
            where the Objective-C runner macros live in their own module. Under CocoaPods
            `@import patrol;` already defines the macro, so the guard skips it.
          </Info>
