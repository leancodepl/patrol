...
<Info>
     **Setting Patrol up with an AI agent?** Paste [these setup instructions] into the
     conversation and ask it to add Patrol to your project — it follows the steps below
     and gets a first test passing on an Android emulator. If your agent supports
     [agent skills], you can install the same instructions as the [`patrol-setup` skill].
</Info>
...
[these setup instructions]: https://raw.githubusercontent.com/leancodepl/patrol/refs/heads/master/skills/patrol-setup/SKILL.md
[`patrol-setup` skill]: https://github.com/leancodepl/patrol/tree/master/skills/patrol-setup
