...
**Option 1: Move tests to patrol_test/ (recommended)**
```bash
# Create the new directory
mkdir patrol_test

# Move your test files
mv integration_test/*_test.dart patrol_test/

# Update any import statements in your tests if needed
```
...
<Info>
If you're using both Flutter's integration_test plugin and Patrol in the same project, we recommend using separate directories to avoid conflicts.
</Info>
