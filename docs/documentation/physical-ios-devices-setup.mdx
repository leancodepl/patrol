...
<Steps>
  ...
  <Step>
    In [Apple Developer Portal](https://developer.apple.com) create new Development Certificate. (You can also use an existing one if you prefer.)
  </Step>
  <Step>
    In [Apple Developer Portal](https://developer.apple.com) create new Development Provisioning Profile that are linked to the new Identifier and include the certificate.
  </Step>
    <Warning>
