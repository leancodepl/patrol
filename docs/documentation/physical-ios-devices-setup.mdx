...
<Steps>
  ...
  <Step>
    In [Apple Developer Portal](https://developer.apple.com) create a new Development Provisioning Profile that is linked to the new Identifier and includes the certificate.
  </Step>
    <Warning>
