...
<Steps>
    ...
    ```
    Set this value to the directory where your patrol tests are located. Default value for `test_directory` is `patrol_test` as this is the default since Patrol 4.0.0.
    </Step>
