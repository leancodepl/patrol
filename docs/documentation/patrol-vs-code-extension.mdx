...
patrol:
  flavor: dev
  test_directory: integration_test # add this line
...
```
You can change those values to your needs. Values you can see here are the default values used by Patrol and Patrol VS Code extension.
3. Ensure your test files are located in the directory and use the suffix you configured above.
