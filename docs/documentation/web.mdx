...
starts on is the main page. It hosts the Flutter app under test, is always open, and can't be closed. One
page is active at a time, and platform actions (taps, text entry, navigation, and so on) run
against it. The main page is active when the test starts.
...
`switchToPage` makes a page active, and `switchToMainPage` takes you back to the Flutter app.
...
`closePage` closes a page by ID. You can't close the main page, and closing the active page
switches you back to the main page:
