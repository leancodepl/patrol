...
Maestro lets you [access features of the platform][native] that the Flutter app is running
on. For example, you can go to the home screen, rotate the device, and then go
back – and you can code this very easily in Dart.

Maestro also provides a [new custom finder system][custom-finders] that extends Flutter's default
