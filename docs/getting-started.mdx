...
<Accordion title="Running patrol test fails containing 'Unsupported class file major version' error">
  ...
  Run `javac -version` to check your JDK version. Patrol requires JDK 17 or higher.
...
[Patrol Discord Server](https://discord.com/channels/1167030497612922931/1167063775925514311).
