...
Patrol's feature of interacting with the native platform has a few limitations.
...
Dart's Zones. This is a Flutter bug, but Patrol is affected by it because it
