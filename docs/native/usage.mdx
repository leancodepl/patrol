...
<Warning>
  ...
  ```dart
  await $.native.tap(Selector(text: 'Add'), appId: 'com.apple.MobileAddressBook');
  ```
</Warning>
...
To tap on the second notfication:
...
await $.native.tapOnNotificationBySelector(
  Selector(textContains: 'Charlie just sent you a secret message!'),
);
```
...
![Permissions many test][permissions_many_test]
...
![Permissions location test][permissions_location_test]
