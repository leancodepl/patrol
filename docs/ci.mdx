...
>
  ...
  <TabItem value="ios">
    ...
    ```
    $ patrol build ios -t integration_test/example_test.dart
    • Building app with entrypoint example_test.dart for iOS device...
    ✓ Completed building app with entrypoint example_test.dart for iOS device (24.8s)
    App path: build/ios_integ/Build/Products/Debug-iphoneos/Runner.app
    Test app path: build/ios_integ/Build/Products/Debug-iphoneos/RunnerUITests-Runner.app
    ```
