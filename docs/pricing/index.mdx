...
| :--- | :--- |
| 1. Patrol Setup in your project (iOS + Android).<br/>2. CI/CD workflow setup, assuming there is a CI/CD like Codemagic and a Firebase project for a given platform (iOS and/or Android).<br/>3. The setup and production-ready, fully automated test with Patrol. | 3500 USD |
| Test(s) using Patrol:<br/>- One test covers one user flow in the app, for example, onboarding or completing a transaction.<br/>- Test scenarios need to be approved prior to the Patrol setup. | from 600 USD per test |

# Patrol Setup - pricing for Enterprises
...
| Fully automated tests with Patrol:<br/>- One test covers one user flow in the app, for example, onboarding or completing a transaction.<br/>- Tests scenarios need to be approved prior to the Patrol setup. | [Contact us](https://leancode.co/get-estimate?utm_source=patrol_page&utm_medium=pricing) |
