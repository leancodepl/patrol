...
<div style={{ display: 'flex', gap: '2rem', alignItems: 'center', justifyContent: 'center', margin: '2rem 0', flexWrap: 'wrap' }}>
  <img src="/assets/credit_agricole_logo.png" alt="Credit Agricole" style={{ height: '60px' }} />
...
| :---- | :---- |
| 1. Patrol Setup in your project (iOS \+ Android)<br/>2. CI/CD workflow setup (Azure DevOps, Github Actions, Bitrise). | 1600 USD<br/>[order Patrol Setup here](https://leancode.co/products/patrol-setup-training) |
