...
* add Patrol test for one test scenario inside your codebase 
...
| :---- | :---- |
| Initial test(s) using Patrol:<br/>The initial test consists of 6-7 steps, for example, the signup process.<br/>Test scenarios need to be approved prior to the Patrol setup. | 1250 USD per test<br/>1000 EUR per test |
| :---- | :---- |
| The setup and production-ready, fully automated test with Patrol | 3750 USD<br/>3000 EUR |

| Offer for Enterprise / large-scale projects | Price for the Setup |
| :---- | :---- |
| Patrol setup using custom CI/CD flows (possibly including Azure DevOps, GitHub Actions, Bitrise, etc.). | Contact us |
| :---- | :---- |
| Up to 3 initial fully automated tests with Patrol:<br/>- Tests consist of 6-7 steps each.<br/>- Test scenarios need to be approved prior to the Patrol setup. | Contact us |
