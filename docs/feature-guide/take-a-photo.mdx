...
We have added a new feature to take a photo using the Android and iOS camera with Patrol. Due to many differences between devices method will not work on 100% devices but should work on most of them.
If device that you are testing on is not working with this command, you can provide your Selectors. To get Native Selectors you can use [Patrol DevTools Extension](https://patrol.leancode.co/documentation/patrol-devtools-extension).
...
<Info>
Method should work without custom selectors on iOS devices. For Android it should work with most of emulators and Pixels Physical devices.
</Info>

## Examples

When you using supported devices you can use this method without any additional arguments:
...
When you using not supported devices you can provide your own selectors:
