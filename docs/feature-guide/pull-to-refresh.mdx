...
- Increase the `steps` for slower, more reliable gestures
- Adjust coordinates based on your app's layout (e.g. center of the screen is not part of scrollable area or even horizontal pull-to-refresh)
