package pl.leancode.patrol.automator

import pl.leancode.patrol.automator.contracts.Contracts
import pl.leancode.patrol.automator.contracts.Contracts.EnterTextRequest.FindByCase.INDEX
import pl.leancode.patrol.automator.contracts.Contracts.EnterTextRequest.FindByCase.SELECTOR
import pl.leancode.patrol.automator.contracts.Contracts.HandlePermissionRequest.Code.DENIED
import pl.leancode.patrol.automator.contracts.Contracts.HandlePermissionRequest.Code.ONLY_THIS_TIME
import pl.leancode.patrol.automator.contracts.Contracts.HandlePermissionRequest.Code.WHILE_USING
import pl.leancode.patrol.automator.contracts.Contracts.SetLocationAccuracyRequest.LocationAccuracy.COARSE
import pl.leancode.patrol.automator.contracts.Contracts.SetLocationAccuracyRequest.LocationAccuracy.FINE
import pl.leancode.patrol.automator.contracts.NativeAutomatorGrpcKt
import pl.leancode.patrol.automator.contracts.empty
import pl.leancode.patrol.automator.contracts.getNativeViewsResponse
import pl.leancode.patrol.automator.contracts.getNotificationsResponse
import pl.leancode.patrol.automator.contracts.permissionDialogVisibleResponse
