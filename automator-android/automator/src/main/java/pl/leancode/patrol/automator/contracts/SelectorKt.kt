...
public inline fun selector(block: pl.leancode.patrol.automator.contracts.SelectorKt.Dsl.() -> kotlin.Unit): pl.leancode.patrol.automator.contracts.Contracts.Selector =
  pl.leancode.patrol.automator.contracts.SelectorKt.Dsl._create(pl.leancode.patrol.automator.contracts.Contracts.Selector.newBuilder()).apply { block() }._build()
public object SelectorKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: pl.leancode.patrol.automator.contracts.Contracts.Selector.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: pl.leancode.patrol.automator.contracts.Contracts.Selector.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): pl.leancode.patrol.automator.contracts.Contracts.Selector = _builder.build()
...
public inline fun pl.leancode.patrol.automator.contracts.Contracts.Selector.copy(block: pl.leancode.patrol.automator.contracts.SelectorKt.Dsl.() -> kotlin.Unit): pl.leancode.patrol.automator.contracts.Contracts.Selector =
  pl.leancode.patrol.automator.contracts.SelectorKt.Dsl._create(this.toBuilder()).apply { block() }._build()
